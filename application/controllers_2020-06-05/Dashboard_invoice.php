...
class Dashboard_invoice extends CI_Controller {	
	...
	public function index() {
		...
		$this->load->view('view_dashboard/dashboard_inv',$data);
	...
	function json_dashboard($json='Y'){
		...
		$Arr_Return['total_potential_bad']		= round($det_ALL[0]['debt_all'] / 1000000);
		$Arr_Return['total_potential_bad_pph']	= round($det_ALL[0]['debt_pph'] / 1000000);
		$Arr_Return['total_potential_bad_ppn']	= round($det_ALL[0]['debt_ppn'] / 1000000);
