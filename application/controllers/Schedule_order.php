	...
	function save_email_schedule_order()
	{
		...
		if ($this->input->post()) {
			...
			if ($OK_Proses ===  1) {
				...
				//echo Dekripsi($rows_Sender->pass_from);exit;
				$mail					= new PHPMailer();
					...
					<table class='noborder' width='100%'>
						<tr>
							...
							<td align='center' width='50%'>
								...
								<font color='#6b6b6b'><b><?php echo $rows_Header->customer_name; ?></b></font><br><br><br><br><br><br><br><br><br><b>
									<font color='#6b6b6b'>---------------------------------------<br>
							</td>
