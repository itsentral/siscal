			...
			<thead>
				<tr class='bg-blue'>
					...
					if ($kategori == 1) {
						...
						// echo "<th class='text-center'>ID Schedule</th>";
						echo "<th class='text-center'>Customer Name</th>";
						echo "<th class='text-center'>Type</th>";
						echo "<th class='text-center'>Address</th>";
						echo "<th class='text-center'>PIC</th>";
						echo "<th class='text-center'>Letter Order ID</th>";
						echo "<th class='text-center'>Nomor SO</th>";
						echo "<th class='text-center'>Nomor Quotation</th>";
						echo "<th class='text-center'>Marketing Name</th>";
						echo "<th class='text-center'>Tool Name</th>";
						echo "<th class='text-center'>Teknisi Name</th>";
				...
				if (isset($records) && $records) {
					...
					foreach ($records as $key => $val) {
						...
						if ($kategori == 1) {
							...
							// echo "<th class='text-center'>" . $val['id'] . "</th>";
							// echo "<td class='text-center'>" . $val['schedule_nomor'] . "</td>";
							echo "<td class='text-center'>" . $val['customer_name'] . "</td>";
							if ($val['insitu'] == 'Y' && $val['labs'] == 'N' && $val['subcon'] == 'N') {
								echo "<td class='text-center'><span class='badge bg-green'>Insitu</span></td>";
							} else if ($val['insitu'] == 'N' && $val['labs'] == 'Y' && $val['subcon'] == 'N') {
								echo "<td class='text-center'><span class='badge bg-maroon'>Labs</span></td>";
							} else {
								echo "<td class='text-center'><span class='badge bg-grey'>Subcon</span></td>";
							}
							echo "<td class='text-center'>" . $val['address_so'] . "</td>";
							echo "<td class='text-center'>" . $val['pic_so'] . "</td>";
							echo "<td class='text-center'>" . $val['letter_order_id'] . "</td>";
							echo "<td class='text-center'>" . $val['no_so'] . "</td>";
							echo "<td class='text-center'>" . $val['quotation_nomor'] . "</td>";
							echo "<td class='text-center'>" . $val['marketing_name'] . "</td>";
							echo "<th class='text-center'>" . $val['tool_name'] . "</th>";
							echo "<th class='text-center'>" . $val['actual_teknisi_name'] . "</th>";
							echo "<td class='text-center'>" . $val['keterangan'] . "</td>";
						}
