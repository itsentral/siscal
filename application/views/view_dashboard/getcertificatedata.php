    ...
    <div class="box-body" style='overflow-x:scroll'>
        <table class="table table-bordered table-striped" id='table_late'>
            <thead>
				...
				<?php
				if($tipe==3){
					echo' <td align="center" class="no-sort">No</td>
					...
					';
					if($tipe==1){
						echo'<td align="center">Penyelia</td>';
					}
				}
				?>
				   ...
				   $int=0;
					...
					foreach($records as $key=>$val){
						...
						echo'<tr>';
							...
							echo'<td align="center"><span class="badge bg-green">'.$leadtime.' </span></td>';							
							if($tipe=='1'){
								echo'<td align="center"><span class="badge bg-purple">'.$val['supervisor_name'].'</span></td>';
							}
                   		echo'</tr>';
					}
			   }
