...
<script type="text/javascript">
	...
	*/
	...
	$(document).on('click','#btn_email_schedule', async(e)=>{
		...
		const ValueCheck	= {
			'nama_pic':{'nilai':EmailName,'error':'Name  Of User Email. Please Input Name  Of User Email First..'},
			'email_pic':{'nilai':EmailAddress,'error':'Empty Email Address. Please Input Email Address First.'}
		};
