...
<table class="gridtable" width='100%'>
	...
	<tr>
		...
		<th width='10%' align='center'>No SO</th>
		<th width='18%' align='center'>Customer</th>
		<th width='20%' align='center'>Nama Alat</th>
		<th width='7%' align='center'>Harga</th>
		<th width='5%' align='center'>Qty</th>
		<th width='7%' align='center'>Disk (%)</th>
		<th width='8%' align='center'>Nett</th>
...
<?php
	...
	if($rows_detail){
		...
		foreach($rows_detail as $key=>$vals){
			...
			if($int > $batas){
				echo "<tr>";
					echo "<td align='right' colspan='9'><b>Sub Total</b></td>";
			...
			echo"<tr>";
				...
				echo"<td width='10%' align='left'>".$vals->no_so."</td>";
				echo"<td width='18%' align='left'>".$vals->customer_name."</td>";
				echo"<td width='20%' align='left'>".$vals->tool_name."</td>";
				echo"<td width='7%' align='right'>".number_format($vals->price)."</td>";
				echo"<td width='5%' align='center'>".number_format($vals->qty)."</td>";
				echo"<td width='7%' align='center'>".number_format($vals->diskon)."</td>";
				echo"<td width='8%' align='right'>".number_format($vals->net_total)."</td>";
				echo"<td width='8%' align='center'>".number_format($vals->nil_incentive)."</td>";
				echo"<td width='12%' align='right'>".number_format($vals->tot_incentive)."</td>";
			echo"</tr>";
		...
		$int++;
		echo "<tr>";
			echo "<th align='right' colspan='9'><b>Grand Total</b></th>";
