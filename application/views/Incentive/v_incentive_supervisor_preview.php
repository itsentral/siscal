		...
		<div class="box-body">
			...
			?>
				...
				<div class='row'>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">Supervisor (Penyelia)</label>
							<?php
				...
				<div class="row">
					<div class="col-sm-12" style="overflow-x:scroll !important;">
						<table class="table table-striped table-bordered" id="my-grid">
								...
								if($rows_detail){
									...
									foreach($rows_detail as $ketD=>$valD){
										...
										echo"<tr>";										
											...
											echo"<td class='text-center'>".number_format($valD->diskon)."</td>";
							...
							<tfoot>
								<tr class='bg-gray'>
									<th class='text-right' colspan='9'><b>Grand Total</b></th>
									<th class='text-right'>
										<?php
