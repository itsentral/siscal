				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<?php
							...
							echo form_dropdown('bulan', $rows_month, '', array('class'=>'form-control chosen-select','id'=>'bulan'));
						?>
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						...
						<select name="tahun" id="tahun" class="form-control chosen-select">
							<?php
								echo "<option value=''>ALL YEAR</option>";	
								//$thn_skr = date('Y');
								$thn_skr = '';
...
<script type="text/javascript">
	...
	*/
	function ActionDetail(ObjectParam){
		let TitleAction	= ObjectParam.title;
		let CodeAction	= ObjectParam.code;
		let LinkAction 	= ObjectParam.action;
		let LinkDetail	= base_url +'/'+ active_controller+'/'+LinkAction+'?code='+encodeURIComponent(CodeAction);
