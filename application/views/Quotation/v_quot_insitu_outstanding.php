		...
		<div class="box-body">
			<div class='form-group row'>			
				...
				<div class='col-sm-6 col-xs-12'>
					<?php
						echo form_button(array('type'=>'button','class'=>'btn btn-sm bg-orange-active','value'=>'save','content'=>'PREVIEW DATA','id'=>'btn-preview')).'&nbsp;&nbsp;<button type="button" id="btn-list-cancel" class="btn btn-sm" style="background-color:#37474f; color:white;vertical-align:middle !important;" title="LIST QUOTATION CANCELLATION"> LIST QUOTATION CANCELLATION <i class="fa fa-long-arrow-right" style="width:40px;"></i> </button>';
...
<script type="text/javascript">
	...
	$(document).on('click','#btn-list-cancel',()=>{
		loading_spinner();
		window.location.href =  base_url+'/'+active_controller+'/list_quotation_cancellation';
	});
