...
<form action="#" method="POST" id="form_proses_survey" enctype="multipart/form-data">
	<div class="box box-warning">		
		...
		<div class='box-footer text-center'>
			...
			&nbsp;&nbsp;&nbsp;<button type="button" id="btn_save_cancel_survey" class="btn btn-md" style="background-color:#37474f; color:white;vertical-align:middle !important;" title="PROCESS CAMCELLATION">PROCESS CAMCELLATION <i class="fa fa-long-arrow-right" style="width:40px;"></i> </button>';
