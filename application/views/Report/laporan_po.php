			...
			echo"<table class='table table-bordered table-striped' id='my-grid'>";
				echo"<thead>";
					echo"<tr class='bg-blue'>";
						...
						echo"<td class='text-center'>No SO</td>";
				...
				echo"<tbody>";
					if($records){
						foreach($records as $key=>$vals){
							...
							$sts_quot		= strtolower($vals['keterangan']);
							if($sts_quot=='new'){
								$status="<span class='badge bg-green'>NEW</span>";
							}else{
								$status="<span class='badge bg-yellow'>REPEAT</span>";
							}
							
							echo"<tr>";
								echo"<td align='left'>".$vals['customer_name']."</td>";
								echo"<td align='left'>".$vals['nomor']."</td>";
								echo"<td align='right'>".number_format($vals['grand_tot'])."</td>";								
								...
								echo"<td align='right'>".number_format($vals['nil_akhir'])."</td>";
								echo"<td align='left'>".$vals['member_name']."</td>";
								echo"<td class='text-center'>".$status."</td>";
								echo"<td align='left'>".$vals['no_so']."</td>";
