	...
	<div class="box box-warning">
		...
		<div class="box-body">
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<?php
						...
						echo form_input(array('id'=>'email_kode','name'=>'email_kode','type'=>'hidden'),$rows_header[0]->id);
					?>							
				</div>
			...
			<div class='form-group row'>			
				...
				<div class='col-sm-4'>
					<div class="btn-group">
						<?php
							echo form_dropdown('inisial_name',array('Bapak'=>'Bapak','Ibu'=>'Ibu'),'Bapak' , array('id'=>'inisial_name', 'class'=>'form-control input-sm'));
						?>
					</div>
					<div class="btn-group">
						<?php
							echo form_input(array('id'=>'pic_name','name'=>'pic_name','class'=>'form-control input-sm'),$rows_header[0]->pic_name);
						?>
					</div>
				</div>
				...
				<div class='col-sm-4'>
					<?php
						echo form_input(array('id'=>'pic_email','name'=>'pic_email','class'=>'form-control input-sm'),$rows_header[0]->pic_email);
					?>							
				</div>				
			</div>
		...
		<div class="box-footer">
			<?php
				...
				echo"<button type='button' class='btn btn-md btn-success' id='btn-save'>EMAIL PROCESS <i class='fa fa-envelope'></i>  </button>";	
			?>
		</div>
	</div>
</form>
...
<script>
	...
	$(document).on('click','#btn-save',function(e){
		...
		if(pic_name=='' || pic_name==null || pic_name=='-'){
			swal({
			  title				: "Error Message !",
		...
		if(pic_email=='' || pic_email==null || pic_email=='-'){
			swal({
			  title				: "Error Message !",
		...
		swal({
			...
			function(isConfirm) {					
				if (isConfirm) {
					...
					var baseurl		= base_url + active_controller+'/email_letter';
					$.ajax({
						url			: baseurl,
						type		: "POST",
						data		: formData,
