	...
	<div class="box box-warning">
		...
		<div class="box-body">
			...
			?>
				...
				<div class='row'>
					<div class="col-sm-6">
						<label class="control-label">Approval Status <span class="text-red">*</span></label>
						<div class="form-check-inline">							
							<label class="form-check-label">
								<input type="radio" class="form-check-input" name="sts_approve" id="sts_approve1" value="APV" checked> <span class="text-green"><b>APPROVE</b></span>
							</label>
							
							&nbsp;&nbsp;&nbsp;&nbsp;
							
							<label class="form-check-label">
								<input type="radio" class="form-check-input" name="sts_approve" id="sts_approve2" value="REJ"> <span class="text-red"><b>REJECT</b></span>
							</label>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label class="control-label">Reject Reason <span class="text-red">*</span></label>
							<?php
								echo form_textarea(array('id'=>'reject_reason','name'=>'reject_reason','class'=>'form-control input-sm','cols'=>75, 'rows'=>2));						
							?>
						</div>
					</div>
...
<script>
	...
	$(document).on('click','#btn-process-approve',(e)=>{
		...
		if($('#sts_approve2').is(':checked')){
			let Reason			= $('#reject_reason').val();			
			if(Reason == null || Reason == '' || Reason == '-'){
				swal({
				  title				: "Error Message !",
				  text				: 'Empty reject reason. Please input reason first...',						
				  type				: "warning"
				});
		...
		swal({
			...
			function(isConfirm) {					
				if (isConfirm) {
					...
					var baseurl		= base_url +'/'+ active_controller+'/save_approval_invoice_process';
					$.ajax({
						url			: baseurl,
						type		: "POST",
						data		: formData,
