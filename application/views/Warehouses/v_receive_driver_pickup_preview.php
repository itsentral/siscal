...
<div class="box box-warning">		
	<div class="box-body">			
		...
		?>
			...
			<div class='row'>
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<?php
							echo form_input(array('id'=>'pickup_nomor_modal','name'=>'pickup_nomor_modal','class'=>'form-control input-sm','readOnly'=>true),$rows_drvhead->nomor);	
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<?php
							echo form_input(array('id'=>'pickup_date_modal','name'=>'pickup_date_modal','class'=>'form-control input-sm','readOnly'=>true),date('d-m-Y',strtotime($rows_drvhead->datet)));						
						?>
					</div>
				</div>				
			</div>
			<div class='row'>
				<div class="col-sm-6">
					<div class="form-group">
						...
						<?php
							echo form_input(array('id'=>'cust_modal','name'=>'cust_modal','class'=>'form-control input-sm','readOnly'=>true),$rows_drvhead->customer_name);
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<?php
							echo form_input(array('id'=>'driver_modal','name'=>'driver_modal','class'=>'form-control input-sm','readOnly'=>true),$rows_drvhead->driver_name);					
						?>
					</div>
				</div>				
			</div>
			<div class='row'>				
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div>
						<?php
							echo '<a href="'.$this->file_attachement.'quotation_receive_tool/'.$rows_drvhead->id.'.pdf" class="btn btn-sm bg-orange-active" target ="_blank"> PREVIEW FILE </a>';	
			...
			$rows_image		= $this->db->get_where('quotation_driver_detail_receive_file',array('driver_detail_receive'=>$rows_drvdetail->id))->result();
