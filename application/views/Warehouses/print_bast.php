...
<?php
	...
	$penerima	= $rows_header['receive_by'];
	$pemberi	= $rows_header['sending_by'];
	if(empty($penerima)){
		$penerima	='---------------------';
	}
...
<table class="noborder3" width='100%'>	
	...
	<tr>
		...
		<td align='center' valign='top' width='4%'>:</td>
		<td align='left' valign='top' width='72%'><b><?php echo $rows_header['name'] ?></b></td>		
	</tr>
	<tr>
		<td align='left' valign='top' width='24%'>Alamat</td>
		<td align='center' valign='top' width='4%'>:</td>
		<td align='left' valign='top' width='72%'><b><?php echo $rows_header['address'] ?></b></td>		
	</tr>	
	<tr>
...
<table class="gridtable" width='100%'>
	<tr>
		...
		<?php 
		if($rows_header['flag_type']=='SUPP' && $rows_header['type_bast']=='DEL'){
...
<table class="noborder3" width='100%'>
	...
	if($rows_header['flag_type']=='CUST' && $rows_header['type_bast']=='SEND'){
