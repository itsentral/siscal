							...
							<tbody id="list_detail">
								...
								if($rows_detail){
									...
									foreach($rows_detail as $ketD=>$valD){
										...
										$Template		= '-';
										if($Flag_Update == 'N' && ($akses_menu['create'] == 1 || $akses_menu['update'] == 1)){
											$Template		="<a href='".site_url('Warehouse_order_update/update_bast_spk_driver?code='.urlencode($Code_BAST))."' class='btn btn-sm bg-orange-active' title='UPDATE BAST'> <i class='fa fa-edit'></i> </a>";
										}										
