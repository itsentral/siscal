	...
	<div class="wrapper">
		<header class="main-header">
			...
			<nav class="navbar navbar-static-top">
				...
				<a class="navbar-brand" href="#"><b>SENTRAL KALIBRASI</b></a>
			...
			<section class="sidebar">
				<ul class="sidebar-menu">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li>
								<a href="<?php echo base_url().'index.php/laporan_quotation';?>"><i class="fa fa-list"></i> <span>Quotation</span></a>
							</li>
							<li>
								<a href="<?php echo base_url().'index.php/laporan_po';?>"><i class="fa fa-check-square"></i> <span>Purchase Order</span></a>
							</li>
							<li>
								<a href="<?php echo base_url().'index.php/laporan_uninvoice';?>"><i class="fa fa-money"></i> <span>SO Outs Invoice</span></a>
							</li>
							<li>
								<a href="<?php echo base_url().'index.php/laporan_pph';?>"><i class="fa fa-recycle"></i> <span>PPH 23</span></a>
							</li>
							...
							<li>
								<a href="<?php echo base_url().'index.php/laporan_quot_subcon';?>"><i class="fa fa-home"></i> <span>Lap Penjualan Subcon</span></a>
							</li>
							<li>
							...
							<li>
								<a href="<?php echo base_url().'index.php/Cashflow_report';?>"><i class="fa fa-money"></i> <span>Chart Cashflow (Plan Payment)</span></a>
							</li>
						</ul>
					</li>
					<li>
						<a href="<?php echo base_url().'index.php/reminder_piutang';?>"><i class="fa fa-bell"></i> <span>AR Reminder Letter</span></a>
					</li>
					<li class="treeview">
					...
					<li class="treeview">
						<a href="#"><i class="fa fa-phone"></i> <span>Custmer Care</span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
						<ul class="treeview-menu">
							<li>
								<a href="<?php echo base_url().'index.php/customer_voice';?>"><i class="fa fa-folder-open"></i> <span>VoC Open</span></a>
							</li>
							
							<li>
								<a href="<?php echo base_url().'index.php/customer_voice_progress';?>"><i class="fa fa-refresh"></i> <span>VoC On Progress</span></a>
							</li>
							<li>
								<a href="<?php echo base_url().'index.php/customer_voice_close';?>"><i class="fa fa-check-square"></i> <span>VoC Close</span></a>
							</li>
							<li>
								<a href="<?php echo base_url().'index.php/customer_voice_cancel';?>"><i class="fa fa-trash"></i> <span>VoC Cancel</span></a>
							</li>
						</ul>
					</li>
					<li class="treeview">
