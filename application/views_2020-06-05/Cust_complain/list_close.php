	...
	function data_display(){
		...
		var table_data = $('#my-grid').dataTable( {
			...
			"columns": [
				...
				{"data":"feedback","sClass":"text-left"},
				{"data":"action","sClass":"text-center","searchable":false}
			],
			"rowCallback": function(row,data,index,iDisplayIndexFull){
				
				let Template		='<a href="'+base_url + active_controller+'/view_detail/'+data.id+'" class="btn btn-sm btn-default" title="View Voc"><i class="fa fa-search"></i></a>';
