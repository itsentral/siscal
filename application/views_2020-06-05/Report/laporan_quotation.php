			...
			echo"<table class='table table-bordered table-striped' id='my-grid'>";
				echo"<thead>";
					echo"<tr class='bg-blue'>";
						echo"<td align='center'>Quotation No</td>";
						echo"<td align='center'>Quotation Date</td>";
						echo"<td align='center'>Customer</td>";
						echo"<td align='center'>Quotation Val</td>";
						echo"<td align='center'>Insitu</td>";
						echo"<td align='center'>Akomodasi</td>";
						echo"<td align='center'>Subcon</td>";
						echo"<td align='center'>Cust Fee</td>";
						echo"<td align='center'>Nett</td>";
						echo"<td align='center'>Sales</td>";
						echo"<td align='center'>Status</td>";
						echo"<td align='center'>Descr</td>";
						echo"<td align='center'>Reff By</td>";
					echo"</tr>";
				echo"</thead>";
				echo"<tbody>";
					if($records){
						foreach($records as $key=>$vals){
							...
							echo"<tr>";
								...
								echo"<td align='center'>".$vals['reference_by']."</td>";
							echo"</tr>";
						}
					}
				echo"</tbody>";
